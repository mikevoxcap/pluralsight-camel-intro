...
-- Load orders
insert into orders.orderType (customer_id, orderNumber, timeorderplaced, lastupdate, status) 
...
insert into orders.orderitem (order_id, catalogitem_id, status, price, quantity, lastupdate)
	values ((select id from orders.orderType where orderNumber = '1001'), 
...
insert into orders.orderitem (order_id, catalogitem_id, status, price, quantity, lastupdate)
	values ((select id from orders.orderType where orderNumber = '1002'), 
		(select id from orders.catalogitem where itemnumber = '078-1344200444'), 'N', 20.00, 1, CURRENT_TIMESTAMP);
insert into orders.orderitem (order_id, catalogitem_id, status, price, quantity, lastupdate)
	values ((select id from orders.orderType where orderNumber = '1003'), 
		(select id from orders.catalogitem where itemnumber = '078-1344200444'), 'N', 20.00, 1, CURRENT_TIMESTAMP);
insert into orders.orderitem (order_id, catalogitem_id, status, price, quantity, lastupdate)
	values ((select id from orders.orderType where orderNumber = '1004'), 
...
insert into orders.orderitem (order_id, catalogitem_id, status, price, quantity, lastupdate)
	values ((select id from orders.orderType where orderNumber = '1005'), 
		(select id from orders.catalogitem where itemnumber = '078-1344200444'), 'N', 20.00, 3, CURRENT_TIMESTAMP);
insert into orders.orderitem (order_id, catalogitem_id, status, price, quantity, lastupdate)
	values ((select id from orders.orderType where orderNumber = '1006'), 
		(select id from orders.catalogitem where itemnumber = '329918349'), 'N', 2.50, 1, CURRENT_TIMESTAMP);
insert into orders.orderitem (order_id, catalogitem_id, status, price, quantity, lastupdate)
	values ((select id from orders.orderType where orderNumber = '1007'), 
